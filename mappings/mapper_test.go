...
const (
	defaultBaseRole = "acs:ram::123456789012:role/"
	roleKey         = "roleKey"
...
func TestExtractRoleARN(t *testing.T) {
	var roleExtractionTests = []struct {
		...
		},
		{
			...
			expectedARN: "acs:ram::123456789012:role/explicit-role",
		},
		{
			test:        "Default present, no annotations",
			annotations: map[string]string{},
			defaultRole: "explicit-default-role",
			expectedARN: "acs:ram::123456789012:role/explicit-default-role",
		},
		{
			test:        "Default present, has annotations",
			annotations: map[string]string{roleKey: "something"},
			defaultRole: "explicit-default-role",
			expectedARN: "acs:ram::123456789012:role/something",
		},
		{
			test:        "Default present, has full arn annotations",
			annotations: map[string]string{roleKey: "acs:ram::999999999999:role/explicit-arn"},
			defaultRole: "explicit-default-role",
			expectedARN: "acs:ram::999999999999:role/explicit-arn",
		},
		{
	...
	for _, tt := range roleExtractionTests {
		t.Run(tt.test, func(t *testing.T) {
			rp := RoleMapper{}
			rp.ramRoleKey = "roleKey"
			rp.defaultRoleARN = tt.defaultRole
			rp.ram = &ram.Client{BaseARN: defaultBaseRole}
...
func TestCheckRoleForNamespace(t *testing.T) {
	var roleCheckTests = []struct {
	...
	}{
		{
			...
			roleARN:              "acs:ram::123456789012:role/explicit-role",
			namespace:            "default",
			expectedResult:       true,
		},
		// glob restrictions
		{
			...
			roleARN:                    "acs:ram::123456789012:role/default-role",
		...
		},
		{
			...
			namespaceRestriction:       true,
			defaultArn:                 "acs:ram::123456789012:role/default-role",
			roleARN:                    "acs:ram::123456789012:role/default-role",
			namespaceRestrictionFormat: "glob",
			expectedResult:             true,
		},
		...
		},
		{
			...
			namespaceRestriction:       true,
			defaultArn:                 "acs:ram::123456789012:role/default-role",
			roleARN:                    "acs:ram::123456789012:role/path/explicit-role",
			namespace:                  "default",
		...
		},
		{
			...
			roleARN:                    "acs:ram::123456789012:role/explicit-role",
			namespace:                  "default",
			namespaceAnnotations:       map[string]string{namespaceKey: "[\"acs:ram::123456789012:role/explicit-role\"]"},
			namespaceRestrictionFormat: "glob",
			expectedResult:             true,
		},
		{
			...
			roleARN:                    "acs:ram::123456789012:role/path/explicit-role",
			namespace:                  "default",
			namespaceAnnotations:       map[string]string{namespaceKey: "[\"acs:ram::123456789012:role/path/*-role\"]"},
			namespaceRestrictionFormat: "glob",
			expectedResult:             true,
		},
		{
		...
		},
		{
			...
			namespaceRestriction:       true,
			roleARN:                    "acs:ram::123456789012:role/glob-role",
			namespace:                  "default",
	...
	for _, tt := range roleCheckTests {
		t.Run(tt.test, func(t *testing.T) {
			rp := NewRoleMapper(
				...
				namespaceKey,
				&ram.Client{BaseARN: defaultBaseRole},
				&storeMock{
